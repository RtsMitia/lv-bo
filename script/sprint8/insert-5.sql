...
('vehicule1', 10, 'E', '07:00:00'),
('vehicule2', 10, 'E', '10:00:00'),
('vehicule3', 4, 'D', '10:00:00'),
('vehicule4', 10, 'D', '10:00:00');

INSERT INTO dev.reservation(id_client, nb_passager, date_heure_arrivee, id_hotel) VALUES
('CL1', 15, '2026-03-25 08:00', 1),
('CL2', 5, '2026-03-25 10:10', 1),
('CL3', 4, '2026-03-25 10:00', 1),
('CL4', 10, '2026-03-25 08:00', 1);
