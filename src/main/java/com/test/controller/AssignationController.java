...
public class AssignationController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (path == null || path.equals("/") || path.equals("/date")) {
            // Afficher le formulaire de sélection de date
            showDateForm(req, resp);
        } else if (path.equals("/list")) {
            // Afficher la liste des trajets pour une date donnée
    ...
    /**
     * Affiche le formulaire de sélection de date
     */
    ...
    /**
     * Affiche la liste des trajets (assignations) pour une date donnée
     */
    private void showAssignationList(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (dateParam == null || dateParam.isEmpty()) {
            // Rediriger vers le formulaire si pas de date
        ...
        try {
            ...
            // Créer un map des hotels pour affichage
